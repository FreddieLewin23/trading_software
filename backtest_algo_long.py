...
def output_model_data_dictionary(date):
...
def quantify_order_size(model, date_of_trade_entry):
    ...
    account_value_df = pd.read_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/account_value.csv')
...
def find_models_to_buy(date_of_current):
    ...
    i = 0
    df = pd.read_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv')
    for index, row in df.iterrows():
    ...
    account_stats = pd.read_csv(
        '/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/account_value.csv')
    ...
    csv_file = '/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv'
...
def check_current_trades(date_of_current):
    ...
    curr_df = pd.read_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv')
    model_order_size_dict = {}
    for index, row in curr_df.iterrows():
        model_order_size_dict[row['model']] = row['order_size']

    df_open_trades = pd.read_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv')
    ...
    existing_data = pd.read_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/completed_trades.csv')
    new_data = pd.DataFrame(data_for_completed_trades, columns=existing_data.columns)
    combined_data = pd.concat([existing_data, new_data], ignore_index=True)
    combined_data.to_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/completed_trades.csv', index=False)
    print("Completed trades added successfully.")

    current_trades_df = pd.read_csv("/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv")
    ...
    df_new.to_csv('/Users/FreddieLewin/PycharmProjects/new_dl_token/backtesting_20251001/data/current_trades.csv', index=False)
